...
{#if showToast && form}
	<div class="toast-container">
		<div class="alert shadow-lg d-flex align-items-center" 
			...
			<div>
				<h6 class="alert-heading fw-bold mb-0">{form.success ? 'Lưu thành công!' : 'Lỗi!'}</h6>
...
<div class="container-fluid p-4">
	<div class="d-flex justify-content-between align-items-center mb-3">
		<h2 class="text-success"><i class="fas fa-map-cog me-2"></i>Json editor</h2>
		<div>
	...
	<div class="row g-4">
		<div class="col-lg-6">
			<div class="card shadow-sm h-100">
				...
				<div class="card-body scrollable-card">
					<form method="POST" action="?/save" use:enhance={submitHandler} id="configForm">
		...
		<div class="col-lg-6">
			<div class="card shadow-sm h-100 border-primary">
				...
				<div class="card-body p-0 code-editor-wrapper">
